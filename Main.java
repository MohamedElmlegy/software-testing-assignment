...
public class Main
{
	public static void main(String[] args) {
		...
		/*int [] arr = {4 , 3, 87, 33, 521 ,451, 111};
		// TODO Auto-generated method stub
		//arithmetic_operation a = new arithmetic_operation() ;
		statistics_operation f = new statistics_operation() ;
		//System.out.println(a.factorial(30));
		//System.out.println(a.addition(5 , 10 ));
		//System.out.println(a.subtraction(2,7));
		//System.out.println(a.multiplication(100,-89));
		//System.out.println(a.division(0,2));
		//System.out.println(a.tothepower(4,0.5));
		//System.out.println(a.bigpower(5,30));
		//System.out.println(a.logarthim(5,7));
		//System.out.println(a.sigma_ci_pwr_p(5,36,1,2));
		//System.out.println((a.sigma_cx_pwr_p(0,arr.length-1,1,arr,1))/arr.length);
		System.out.println(f.getMean(arr));
		System.out.println(f.getMedian(arr));
		System.out.println(f.getMode(arr));
		System.out.println(f.getRange(arr));
		System.out.println(f.getMin(arr));		
		System.out.println(f.getMax(arr));
		System.out.println(f.getQuartiles(arr));
		System.out.println(f.getInterquartileRange(arr));
		System.out.println(f.getOutliers(arr));*/
